...
public class Pgrm16Point {
        ...
        public Pgrm16Point(int x, int y){
            this.x=x;
            this.y=y;
        ...
        public double distance(Pgrm16Point point){

            return distance(point.getX(), point.getY());
        }

        public static void main(String[] args) {
            Pgrm16Point first = new Pgrm16Point(6, 5);
            Pgrm16Point second = new Pgrm16Point(3, 1);
            System.out.println("distance(0,0)= " + first.distance());

            System.out.println("distance(second)= " + first.distance(second));
            System.out.println("distance(2,2)= " + first.distance(2, 2));
           Pgrm16Point point = new Pgrm16Point();
            System.out.println("distance()= " + point.distance());
        }
    }
