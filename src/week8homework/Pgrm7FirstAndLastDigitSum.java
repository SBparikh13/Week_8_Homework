...
public class Pgrm7FirstAndLastDigitSum {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);//declare scanner
        System.out.println("Enter a digit : ");
        int n= sc.nextInt();
        System.out.println("Sum of first and last digit is " + (firstDigit(n) + lastDigit(n)));
        sc.close();
    }

        // Find the first digit
        public static int firstDigit(int n) {//static method
